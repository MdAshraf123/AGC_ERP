...
export function MyContextProvider({ children }){
    ...
    async function  refresh(navigate){
        ...
        let refreshtoken=import.meta.env.VITE_REFERESH_TOKEN;
    ...
    async function login(user, pass){
            let apitoken=import.meta.env.VITE_CREATE_TOKEN;
...
//
    function user(){
        if(islogin){
            ...
            let url=import.meta.env.VITE_API_BASE_URL+'student_profile/';
            if(userdata.role=='faculty')
                url=import.meta.env.VITE_API_BASE_URL+'employee/';
